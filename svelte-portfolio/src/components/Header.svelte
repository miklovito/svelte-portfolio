...
<header class={'sticky z-[10"] top-0 duration-200 pc-6 flex items-center justify-between border border-solid ' + (y > 0 ? 'px-4 py-4 bg-slate950 border-violet-950' : 'py-6 bg-transparent border-transparent')}>
    <h1 class="font-medium">
        <b class="font-bold poppins">Garry</b> Manalo
    </h1>
    <div class="sm:flex ml-auto px-4 text-left gap-4 hidden">
