...
<a href={step.href} target="_blank" class="p-4 sm:p-8 flex flex-col gap-4 rounded-lg border border-slid border-violet-700 text-center ground cursor-pointer hover:border-violet-400 duration-200">
    ...
    <h3 class="font-meduim text-xl sm:text-2xl md: text-3xl">{step.name}</h3>
    <slot/>
